...
struct AST : public zone::ZoneObject {
  ...
  AST(const vcl::util::CodeLocation& loc, ASTType t) : type(t), location(loc) {}
...
struct Import : public AST {
  Import(const vcl::util::CodeLocation& loc, zone::ZoneString* name)
      : AST(loc, AST_IMPORT), module_name(name) {}
...
struct Chunk : public AST {
  Chunk(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_CHUNK), statement_list(), location_end(loc) {}
...
struct LexScope : public AST {
  LexScope(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_LEXSCOPE), body(NULL) {}
...
struct Sub : public AST {
  Sub(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_SUB), arg_list(), sub_name(NULL), body(NULL) {}
...
struct ExtensionLiteral : public AST {
  ExtensionLiteral(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_EXTENSION_LITERAL), type_name(NULL), initializer(NULL) {}
...
struct ExtensionInitializer : public AST {
  ...
  ExtensionInitializer(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_EXTENSION_INITIALIZER), list() {}
...
struct Dict : public AST {
  Dict(const vcl::util::CodeLocation& loc) : AST(loc, AST_DICT), list() {}

  struct Entry {
    AST* key;
    AST* value;
    Entry() : key(NULL), value(NULL) {}
    Entry(AST* k, AST* v) : key(k), value(v) {}
  };
...
struct ACL : public AST {
  ACL(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_ACL), name(NULL), list() {}

  struct ACLItem {
    zone::ZoneString* name;
    uint8_t mask;
    bool negative;
    ACLItem() : name(NULL), mask(0), negative(false) {}
  };
...
struct Global : public AST {
  Global(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_GLOBAL), name(NULL), value(NULL) {}
  zone::ZoneString* name;
  AST* value;
...
struct List : public AST {
  List(const vcl::util::CodeLocation& loc) : AST(loc, AST_LIST), list() {}
...
struct Return : public AST {
  Return(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_RETURN), value(NULL) {}

  Return(const vcl::util::CodeLocation& loc, AST* v)
      : AST(loc, AST_RETURN), value(v) {}
...
struct Terminate : public AST {
  Terminate(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_TERMINATE), value(NULL), action() {}
...
struct LeftHandSide {
  ...
  explicit LeftHandSide(zone::ZoneString* v) : type(VARIABLE), variable(v) {}

  explicit LeftHandSide(ast::Prefix* p) : type(PREFIX), prefix(p) {}
...
struct Set : public AST {
  Set(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_SET), lhs(), rhs(NULL), op(TK_ERROR) {}
...
struct Unset : public AST {
  Unset(const vcl::util::CodeLocation& loc) : AST(loc, AST_UNSET), lhs() {}
...
struct Declare : public AST {
  Declare(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_DECLARE), variable(NULL), rhs(NULL) {}
...
struct If : public AST {
  ...
  If(const vcl::util::CodeLocation& loc) : AST(loc, AST_IF), branch_list() {}
...
struct For : public AST {
  ...
  For(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_FOR), iterator(NULL), key(NULL), val(NULL), body(NULL) {}
};

struct Continue : public AST {
  Continue(const vcl::util::CodeLocation& loc) : AST(loc, AST_CONTINUE) {}
};

struct Break : public AST {
  Break(const vcl::util::CodeLocation& loc) : AST(loc, AST_BREAK) {}
};

struct Ternary : public AST {
  Ternary(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_TERNARY), condition(NULL), first(NULL), second(NULL) {}
...
struct Binary : public AST {
  Binary(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_BINARY), lhs(NULL), rhs(NULL), op(TK_ERROR) {}

  Binary(const vcl::util::CodeLocation& loc, AST* l, AST* r, Token o)
      : AST(loc, AST_BINARY), lhs(l), rhs(r), op(o) {}
...
struct Unary : public AST {
  Unary(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_UNARY), ops(), operand(NULL) {}
...
struct Prefix : public AST {
  ...
  struct Component {
    ...
    Component(zone::ZoneString* v, int tag = DOT) : tag(tag), var(v) {
...
struct StringConcat : public AST {
  StringConcat(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_STRING_CONCAT), list() {}
...
struct Null : public AST {
  Null(const vcl::util::CodeLocation& loc) : AST(loc, AST_NULL) {}
...
struct StringInterpolation : public AST {
  StringInterpolation(const vcl::util::CodeLocation& loc)
      : AST(loc, AST_STRING_INTERPOLATION), list() {}
...
struct File : public AST {
  File(const vcl::util::CodeLocation& loc) : AST(loc, AST_FILE), chunk(NULL) {}
