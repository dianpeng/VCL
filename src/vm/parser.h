...
class Parser {
 ...
 private:
  ...
  bool m_support_desugar; // whether we need to desugard during the parsing ,
...
// Check whether a variable is generated by the parser or not
bool IsGeneratedVariableName( zone::ZoneString* );
